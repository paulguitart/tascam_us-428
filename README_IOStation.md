...
- `TOUCH_GLOW_LOW_COLOR = AMBER`: color just below unity, including PreGain.
- `TOUCH_GLOW_BOTTOM_COLOR = BLUE`: minimum-volume color for track, Send, Stereo Out and FX Return; PreGain keeps LOW_COLOR throughout. Set both LOW_COLOR and BOTTOM_COLOR to AMBER for a single-color volume fade.
